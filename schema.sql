...
CREATE TABLE IF NOT EXISTS irr_runs (
  ...
  start_after   DATETIME DEFAULT NULL, -- set in phase 1; run may not open before this
...
CREATE TABLE IF NOT EXISTS irr_settings (
  ...
  master_lead_seconds INT NOT NULL DEFAULT 15,  -- master opens this early, closes this late
  master_close_after  DATETIME DEFAULT NULL,    -- when the master may finally close
